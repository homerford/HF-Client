...
function Home(props) {
    ...
    const [loggedIn] = useState( !!window.sessionStorage.getItem('current_user'));
    const [currentUser] = useState(JSON.parse(window.sessionStorage.getItem('current_user')));
    ...
    function handleImageNext() {
        const el_next = document.querySelector(".image-content-next-button");
        const el_back = document.querySelector(".image-content-back-button");
        const el_scrollContainer = document.querySelector(".home-image-content");
            ...
            <>
                <div className="new-home-content">
                    <div className="main-text-panel">
                        ...
                        <div className="main-text-body" style={{fontSize: "1.75vmin"}}>The Homer Ford Tennis Center is
                            the perfect place to play tennis. Whether it's a tournament,
                            a practice game, or even a couples' date night, the Homer Ford Tennis Center is the place
                            for you!
                        </div>
                        <div className="main-text-body-button-container">
                            <Link className="main-text-body-button" to={loggedIn
                                ? "/reserve"
                                : "/login"}>Schedule Now</Link>
                    ...
                    <div className="main-image-panel">
                        <div className="home-image-content">
                            ...
                            <div className="slide-image-1"/>
                            <div className="slide-image-2"/>
                            <div className="slide-image-3"/>
                        </div>
                ...
                {loggedIn && <div className="user-welcome">Welcome back, <b
                    style={{marginLeft: '0.5vmin'}}>{currentUser.User_firstname}</b>!</div>}
            </>
        )
    }
